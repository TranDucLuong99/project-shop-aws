  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                 <div class="col-sm-6">
                        <a href="{{route('new.get_create')}}" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Thêm tin tức</a>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
              ...
              <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($key->image)
                                <img style="max-width:150px; height: 50px;" src="{{asset('images/new/'.$key->image)}}">
                            @endif
                        </td>
                        ...
                        <td style="text-align: center">
                        <a href="{{route('new.get_edit',$key->id)}}" class="btn btn-default">
        ...
        <!-- /.row -->
        @include('Admin.news.delete_modal')
        @include('Admin.news.restore_modal')
      </div>
      <!-- /.container-fluid -->
    </section>
    <!-- /.content -->
