  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                 <div class="col-sm-6">
                        <a href="{{route('user.get_create')}}" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Thêm user</a>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center">
                            @if($key->image)
                                <img style="max-width:150px; height: 50px;" src="{{asset('images/user/'.$key->image)}}">
                            @endif
                        </td style="text-align: center">
                        <td style="text-align: center">
                        {!!($key->is_active == 1) ?
                        ...
                        <td style="text-align: center">
                        <a href="{{route('user.get_edit',$key->id)}}" class="btn btn-default">
        ...
        @include('Admin.users.restore_modal')
      </div>
      <!-- /.container-fluid -->
    </section>
    <!-- /.content -->
